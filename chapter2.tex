...
The BS recovers the characters the same way thery were encoded. It also recieves the encoded interval which it uses to decode by using the probability values saved in its storage.
